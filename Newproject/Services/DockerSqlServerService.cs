...
{
    private const string ContainerName = "newproject-mssql";
    private const string SaPassword = "NewProject2024!";
    private const int HostPort = 1434;

    public static string ConnectionString =>
        $"Server=localhost,{HostPort};Database=NewprojectDb;User Id=sa;Password={SaPassword};TrustServerCertificate=True;";
